...
-- Dumping data for table backbone.list: ~4 rows (approximately)
/*!40000 ALTER TABLE `list` DISABLE KEYS */;
INSERT INTO `list` (`id`, `title`, `url`, `price`, `priority`, `user_id`) VALUES
	(43, 'KAMVAS Pro 12 11.6-inch Digital Graphics Tablet Passive Pen Display Drawing Monitor', 'https://www.aliexpress.com/item/KAMVAS-Pro-12-11-6-inch-Digital-Graphics-Tablet-Passive-Pen-Display-Drawing-Monitor-with-Tilt/32952713376.html', '$296', '2', 58),
	...
	(46, 'HOMTOM ZOJI Z11 IP68 Waterproof Dust Proof 10000mAh Smartphone 4GB ', 'https://www.aliexpress.com/item/HOMTOM-ZOJI-Z11-IP68-Waterproof-Dust-Proof-10000mAh-Smartphone-4GB-64GB-Octa-Core-Cell-Phone-5/32967132425.html', '$196', '1', 58),
	(47, 'INQMEGA HD 1080P Cloud Wireless IP Camera Intelligent Auto Tracking Of Human', 'https://www.aliexpress.com/item/INQMEGA-HD-1080P-Cloud-Wireless-IP-Camera-Intelligent-Auto-Tracking-Of-Human-Home-Security-Surveillance-CCTV/32885045390.html', '$18.60', '1', 65),
...
-- Dumping data for table backbone.user: ~3 rows (approximately)
...
INSERT INTO `user` (`user_id`, `username`, `password`, `name`, `description`) VALUES
	...
	(65, 'lakshang', 'ass19980813', 'Birthday', 'Items for birthday'),
